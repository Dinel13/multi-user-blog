...
export default function Login() {
  ...
  return (
    <div class="w-full max-w-md my-8 p-10 m-auto bg-white border-gray-300 border rounded-md shadow-md dark:bg-gray-800">
      <h1 class="text-3xl font-semibold text-center text-gray-700 dark:text-white">
        UnhasTa
      </h1>
      <form class="mt-6" onSubmit={loginHandler}>
        <div>
          <label
            for="username"
        ...
        <div class="mt-6">
          <button class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-pink-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
            Masuk
          </button>
        </div>
      </form>
      ...
      <p class="mt-8 text-sm font-light text-center text-gray-700">
        Belum Punya Akun?{" "}
        <Link
          to="/daftar"
